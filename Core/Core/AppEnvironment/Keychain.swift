...
public class Keychain {
    ...
    public static var app = Keychain(serviceName: "com.eskwelabs.shared-credentials", accessGroup: Bundle.main.appGroupID())
    public static var shared = Keychain(serviceName: "com.eskwelabs.shared-credentials", accessGroup: "group.eskwelabs.shared")

    init(serviceName: String = Bundle.main.bundleIdentifier ?? "com.eskwelabs.general-purpose-keychain", accessGroup: String? = nil) {
