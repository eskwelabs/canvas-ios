    ...
    init(machPortName: String, runOnMainQueue: Bool) {
        ...
        if runOnMainQueue {
            ...
            let thread = Thread {
                ...
                let mode = CFRunLoopMode("com.eskwelabs.ipc-server" as CFString)
...
class IPCAppServer: IPCServer {
    static func portName(id: String) -> String {
        "com.eskwelabs.icanvas.ui-test-app-\(id)"
    }
...
class IPCDriverServer: IPCServer {
    static func portName(id: String) -> String {
        "com.eskwelabs.icanvas.ui-test-driver-\(id)"
    }
...
class IPCClient {
    ...
    func requestRemote<R: Codable>(_ request: R) throws -> Data? {
        ...
        let mode = "com.eskwelabs.ipc-client" as CFString
