...
extension Notification.Name {
    static let moduleItemViewDidLoad = Notification.Name(rawValue: "com.eskwelabs.core.notification.ModuleItemViewDidLoad")
    public static let moduleItemRequirementCompleted = Notification.Name(rawValue: "com.eskwelabs.core.notification.ModuleItemRequirementCompleted")
}
